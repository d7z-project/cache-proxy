...
import (
	...
	_ "gopkg.d7z.net/cache-proxy/pkg/proxy/apk"
	_ "gopkg.d7z.net/cache-proxy/pkg/proxy/cargo"
	_ "gopkg.d7z.net/cache-proxy/pkg/proxy/deb"
	...
	_ "gopkg.d7z.net/cache-proxy/pkg/proxy/pacman"
	_ "gopkg.d7z.net/cache-proxy/pkg/proxy/pypi"
	_ "gopkg.d7z.net/cache-proxy/pkg/proxy/rpm"
