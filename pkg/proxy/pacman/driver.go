...
func (Driver) Plan(_ context.Context, plan *proxyruntime.InstancePlan) error {
	...
	client, err := transport.NewPlanClient(plan, config.ModePacman)
	if err != nil {
	...
	storeio.RegisterResponseCleanup(plan.Scheduler(), plan.Name(), pacmanTenant, plan.Store(), plan.CleanupConfig())
